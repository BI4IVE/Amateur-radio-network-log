...
- 修复深色环境下未显式设色的表单控件出现「白字白底」不可见的问题：移除全局深色媒体查询（全站本就是浅色设计）
- 优化表单控件基础样式兜底：输入框、下拉框、文本域统一黑字白底，占位文字统一灰色
- 修复微信绑定页输入框文字发灰、看不清的问题
...
| 章节 | 说明 |
|------|------|
| [项目简介](docs/01-intro.md) | 系统概述与核心优势 |
| [功能特性](docs/02-features.md) | 模块能力与功能清单 |
| [技术栈](docs/03-tech-stack.md) | 前后端与工具链 |
| [快速开始](docs/04-quick-start.md) | 环境要求与本地开发 |
| [部署指南](docs/05-deployment.md) | 宝塔 / 传统 Linux / Docker 四种部署方式 + 避坑记录 |
| [更新方式](docs/06-update.md) | 升级流程、版本源一致性与回滚 |
| [使用文档](docs/07-usage.md) | 角色说明与操作指南 |
| [常见问题](docs/08-faq.md) | 部署与使用的常见问题 |
| [更新日志](docs/09-changelog.md) | 全部版本变更记录（v1.0.0 起） |
| [贡献指南](docs/10-contributing.md) | 开发流程、代码规范、协议与致谢 |
| [微信推送说明](docs/11-wechat-push.md) | 公众号要求、模板配置与逐步接入步骤 |
...
<div align="center">
  <img src="sponsor/weixin.jpg" alt="微信赞赏码" width="240" />
  <img src="sponsor/afdian.jpg" alt="爱发电赞助码" width="240" />
</div>

- ❤️ **爱发电**：<https://afdian.com/a/bd4jn>（按月 / 任意赞助，支持微信与支付宝）
...
**73** 是业余无线电界的祝福与告别，意为「Best Regards」（最好的祝愿）。感谢每一位 HAM 朋友！

![济南黄河业余无线电](https://img.shields.io/badge/%E6%B5%8E%E5%8D%97%E9%BB%84%E6%B2%B3%E4%B8%9A%E4%BD%99%E6%97%A0%E7%BA%BF%E7%94%B5-%E5%8F%B0%E7%BD%91-ff9d3f?style=flat-square&logo=radioamateurs&logoColor=white)
![Amateur Radio](https://img.shields.io/badge/Amateur-Radio-ffd78a?style=flat-square&logo=radioamateurs&logoColor=white)
![BR4IN](https://img.shields.io/badge/Callsign-BR4IN-141a2e?style=flat-square)
![BD4JN](https://img.shields.io/badge/Callsign-BD4JN-8fa3c8?style=flat-square)
